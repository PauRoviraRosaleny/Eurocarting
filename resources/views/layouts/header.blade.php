...
<header class="p-3" >
    <div class="header-container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="text-end">
                <a href="{{ route('login') }}"><button type="button" class="btn btn-danger me-2">Iniciar sesión</button></a>
                <a href="{{ route('register') }}"><button type="button" class="btn btn-danger me-2">Registrarse</button></a>
                <a href="{{ route('contact') }}"><button type="button" class="btn btn-danger me-2">Contáctanos</button></a>
            </div>
            @endguest
